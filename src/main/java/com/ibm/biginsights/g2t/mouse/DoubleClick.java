...
public class DoubleClick extends MouseEvent
{
    private Point point;

    public DoubleClick(MouseButton button, Point point, long offset)
    {
        this.button = button;
        this.point = point;
        this.offset = offset;
    ...
    public JSONObject toJsonObject() throws IOException, JSONException
    {
        ...
        json.put(ACTION, DoubleClick.class.getName());
    ...
    public boolean equals(Object obj)
    {
        ...
        DoubleClick rhs = (DoubleClick) obj;
